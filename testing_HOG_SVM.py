...
model = joblib.load('/Users/deeptej/Desktop/Object-detection-via-HOG-SVM-master/model_name.npy')

# Test the trained classifier on an image below!
scale = 0
detections = []
# read the image you want to detect the object in:
img= cv2.imread("/Users/deeptej/Desktop/desktop-items/codes/Autonomous landing/imagesDJI_0702520.jpg")
...
if k == 27:             #wait for ESC key to exit
    ...
    cv2.imwrite('/Users/deeptej/Desktop/Object-detection-via-HOG-SVM-master/test1.png',img)
    cv2.destroyAllWindows()
